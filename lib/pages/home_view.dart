          ...
          children: [
            Container(
              ...
              child: vm.loading
                ...
                children: [
                  const Text('Nómina Mensual Actual:', style: TextStyle(color: Colors.white)),
            ...
            Wrap(
              ...
              children: [
                ...
                _HomeButton(
                  ...
                  onTap: () => Navigator.pushNamed(context, '/aprobarSolicitudes'),
                ),
                _HomeButton(
...
class _HomeButton extends StatelessWidget {
  ...
  const _HomeButton({required this.icon, required this.label, required this.onTap, super.key});
